...
d1d2_both <- intersect(d1_diet_2015$`Respondent sequence number`, d2_diet_2015$`Respondent sequence number`)

#combine d1 and d2
d1d2_diet_2015 <- rbind(d1_diet_2015, d2_diet_2015)
d1d2_diet_2015 <- d1d2_diet_2015[d1d2_diet_2015$`Respondent sequence number` %in% d1d2_both,]
